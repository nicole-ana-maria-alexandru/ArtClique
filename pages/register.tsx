        ...
        <Stack spacing={8} mx={"auto"} maxW={"lg"} py={12} px={6}>
          ...
          <Box rounded={"lg"} bg="#181820" shadow={"purple"} p={8}>
            <Stack spacing={4}>
              ...
              <Box>
                <FormControl>
                  <FormLabel htmlFor="country" color={"white"}>Country</FormLabel>
                  <Select id="country" placeholder="Select country" color={"white"} ref={countryRef}>
                    {countryList.map((country: any) => (
                      <option key={country} style={{ color: 'black' }}>{country}</option>
                    ))}
                  </Select>
                </FormControl>
              </Box>
